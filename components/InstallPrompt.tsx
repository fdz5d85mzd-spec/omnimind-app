...
export default function InstallPrompt() {
  ...
  return (
    ...
    <div className="fixed bottom-24 right-4 sm:bottom-4 z-50 flex items-center gap-3 rounded-2xl bg-card/95 backdrop-blur-xl border border-white/[0.08] shadow-panel px-4 py-3 max-w-xs animate-fadeIn">
