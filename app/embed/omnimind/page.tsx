 ...
 * help button, language rail, Worlds menu or secondary product links. The
 * parent OmniMindAI shell owns navigation and legal/help surfaces.
 *
 * The two CTA buttons navigate the top-level browser back into OmniMindAI
 * routes, so OmniMind feels like one product rather than a nested standalone
 * website.
 */
